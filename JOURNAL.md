...
![Panic / emergency module concept](assets/journal/Panic.png)
...
![1.5" OLED selection / upgrade](assets/journal/Oled.png)
...
![ESP32-S3 ProS3 module](assets/journal/ProS3.jpg)
...
![JST connectors + screw terminals for modular ports](assets/journal/Terminais.png)
...
![PCB routing / traces snapshot](assets/journal/Trilhas.png)
...
![OLED window + chamfer detail (CAD)](assets/journal/Chanfro.png)
...
![Bottom cover / underside view (CAD)](assets/journal/ViewBottom.png)
...
![Back view with ventilation slots (CAD)](assets/journal/BackView.png)
...
![JLCPCB / LCSC parts selection snapshot](assets/journal/PlacaJLC.png)
...
![Final PCB render (white solder mask) — latest](assets/journal/PCB_Branca.png)
